...
// NOTE: the below stuff is taken from Adafruit's library for OV7670 on the Arduino
//  They have a bunch of "default values" that aren't written in the datasheet but are required for the camera to work.
//  TL;DR this camera documentation sucks.
...
// List of register values that need to be changed from the above default values to enable RGB565 video output.
static struct regval_list ov7670_fmt_rgb565[] = {
  { REG_COM7, COM7_FMT_QVGA|COM7_RGB }, /* Selects QVGA RGB mode */
