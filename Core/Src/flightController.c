 ...
 *
 * @param currentMotorThrottle: pointer to a 4-element array containing the current speeds of the motors
 ...
 * @param motorController: pointer to a motorController object
 *
 */
void actuateMotors(float* currentMotorThrottle, float* controlSignals, float* vvAccumulator, float verticalVelocityMotorAdjustment, float rcThrottle, motorController* mtrController) {
  *vvAccumulator += verticalVelocityMotorAdjustment;
  ...
  // set motor speeds based on control signals
  motorSetSpeed(mtrController, frontRightMotor, currentMotorThrottle[0]);
  motorSetSpeed(mtrController, frontLeftMotor, currentMotorThrottle[1]);
  motorSetSpeed(mtrController, rearRightMotor, currentMotorThrottle[2]);
  motorSetSpeed(mtrController, rearLeftMotor, currentMotorThrottle[3]);
}
